...
*   **Text Changes:** Pull latest git changes and run `docker compose up -d --build`.
*   **Asset Changes (PDF/Photo):** Just replace the files in the `user-data` folder on your server. No rebuild needed.
